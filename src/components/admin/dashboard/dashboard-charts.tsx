        ...
        {estoquePorCategoria.length === 0 ? (
          ...
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={estoquePorCategoria} layout="vertical" margin={{ top: 4, right: 16, left: 8, bottom: 0 }}>
              ...
              <XAxis type="number" allowDecimals={false} tick={{ fill: chart.axis, fontSize: 11, fontFamily: "var(--font-geist-mono)" }} tickLine={false} axisLine={false} />
              <YAxis type="category" dataKey="label" tick={{ fill: chart.axis, fontSize: 12, fontFamily: "var(--font-geist-mono)" }} tickLine={false} axisLine={false} width={90} />
